          ...
          builder_query = {
            spec = {
              ...
              metrics = {
                ...
                legend                 = "{{k8s.cluster.name}} {{k8s.namespace.name}} {{k8s.volume.name}}"
                limit                  = null
                limit_by               = null
                name                   = "A"
                offset                 = null
...
# have to copy C manually to make it work after apply
# something wrong with the terrafrom pprovider
# https://github.com/SigNoz/terraform-provider-signoz/issues/132
